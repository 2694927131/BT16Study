Create one horizontal animation strip for Codex pet `bytebud`, state `running-right`.
...
Identity: same pet in every frame: Compact friendly mascot inspired by Android and Bluetooth engineering: small rounded teal-and-charcoal helper with subtle circuit markings, antenna-like ears suggesting wireless signals, a tiny debug-console charm, patient focused expression, clean readable whole-body silhouette, no logos, no text.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Polished soft vinyl toy mascot, readable at small size, teal charcoal white accents, warm curious expression, no brand logos or readable marks..
