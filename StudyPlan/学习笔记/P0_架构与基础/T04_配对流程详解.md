...
|---|--------|------|
| 1 | Mermaid图 ≥ 3个 | ✅ 5个 |
| 2 | 代码片段 ≥ 5个 | ✅ 14个带逐行注释的代码片段 |
| 3 | C++知识卡片 ≥ 2个 | ✅ 3个（函数指针回调表vs Java接口、位域bit-field与BRSF、枚举enum class vs C枚举） |
| 4 | Java↔C++对照表 | ✅ 10项对照 |
| 5 | 行号标注 | ✅ 所有关键函数标注文件:行号 |
| 6 | 问题排查SOP | ✅ 2个SOP |
| 7 | 动手练习 | ✅ 🟢🟡🔴 3级 |
| 8 | 代码导航表 | ✅ 47项 |
| 9 | 前置知识 | ✅ T01（蓝牙整体架构理解）、T02（蓝牙开关流程）、T03（设备扫描流程） |
| 10 | 车载场景 | ✅ 车载无屏/CarPlay/HiCar等特殊配对场景 |
